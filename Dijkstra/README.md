...
### Mesafe Tablosu (Adım Adım)

| Adım | İşlenen Düğüm | A    | B    | C    | D    | Notlar |
|------|--------------|------|------|------|------|--------|
| 0    | —            | **0**| ∞    | ∞    | ∞    | Başlangıç durumu |
| 1    | **A** (0)    | 0    | 4    | 2    | ∞    | A'nın komşuları B(4) ve C(2) güncellendi |
| 2    | **C** (2)    | 0    | 3    | 2    | 5    | C üzerinden B: 2+1=3 < 4 ✅ Güncellendi; D: 2+3=5 |
| 3    | **B** (3)    | 0    | 3    | 2    | 5    | B üzerinden D: 3+5=8 > 5, güncelleme yok |
| 4    | **D** (5)    | 0    | 3    | 2    | **5**| D'nin komşusu yok, tamamlandı |

---

### Sonuç: A'dan Her Düğüme En Kısa Mesafeler
...
2. adımda B düğümünün mesafesi `4`'ten `3`'e güncellendi.  
Bu, Dijkstra'nın gücünü gösterir: **dolaylı bir yol daha kısa olabilir!**  
`A → C → B` (2+1=3), `A → B` (4) yolundan daha ucuzdur.
